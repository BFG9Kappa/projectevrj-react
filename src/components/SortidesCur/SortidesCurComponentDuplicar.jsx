...
function SortidesCurComponentDuplicar({ setValidationErrors }) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/sortidescurriculars/duplicar/"+ id)
      .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:5000/api/sortidescurriculars/create/", item)
      .then((response) => {
...
export default SortidesCurComponentDuplicar;
